...
sheets_auth(email = "mars.fatih@gmail.com")
...
sheet_mbl = sheet_mbl %>% select(c("Category", "Fuel_type", "Fuel_subtype", "Country", "City_state_or_province", "Start", "End", 
                                   "Sources_and_more_info","Sources_2", "Sources_3", "Notes"))
names(sheet_mbl) = c("Category", "Fuel Type", "Fuel Subtype", "Country", "City, state, or province", "Start", "End", 
                     "Sources and more info", "Sources 2", "Sources 3", "Notes")

# select relevant columns from mbl-sheet and store in new csv file
sheet_sr = sheet_sr %>% select(c("Category", "Fuel_type", "Fuel_subtype", "Country", "City_state_or_province", "Start", "End", "Description",
                                 "Sources_and_more_info","Sources_2", "Sources_3", "Notes")) 
names(sheet_sr) = c("Category", "Fuel Type", "Fuel Subtype", "Country", "City, state, or province", "Start", "End", "Description",
                    "Sources and more info", "Sources 2", "Sources 3", "Notes")

# select relevant columns from mbl-sheet and store in new csv file
sheet_div = sheet_div %>% select(c("Category", "Divestment_type", "Organisation", "Organisation_type", "Country", "City_state_or_province", "Start", 
                                   "Sources_and_more_info","Sources_2", "Sources_3", "Notes"))
names(sheet_div) = c("Category", "Divestment type", "Organisation", "Organisation_type", "Country", "City, state, or province", "Start", 
                     "Sources and more info", "Sources 2", "Sources 3", "Notes") 
